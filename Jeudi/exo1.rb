...
#Ajout d'une méthode dans l'instance de classe String
class String
  def numeric?
...
#Affichage du nombre de journalistes
def nombre_de_journaliste(journalistes)
  puts "Il y a #{journalistes.size} journalistes dans le tableau."
end
